...
#ifndef ROBOT_INTERFACE__SRV__DETAIL__ROBOT_INIT__FUNCTIONS_H_
#define ROBOT_INTERFACE__SRV__DETAIL__ROBOT_INIT__FUNCTIONS_H_
...
/// Initialize srv/RobotInit message.
/**
...
/// Finalize srv/RobotInit message.
/**
...
/// Create srv/RobotInit message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_interface__srv__RobotInit_Request__init().
...
/// Destroy srv/RobotInit message.
/**
 * It calls
 * robot_interface__srv__RobotInit_Request__fini()
...
/// Check for srv/RobotInit message equality.
/**
...
/// Initialize array of srv/RobotInit messages.
/**
...
/// Finalize array of srv/RobotInit messages.
/**
 * It calls
 * robot_interface__srv__RobotInit_Request__fini()
...
/// Create array of srv/RobotInit messages.
/**
 * It allocates the memory for the array and calls
 * robot_interface__srv__RobotInit_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RobotInit messages.
/**
 * It calls
 * robot_interface__srv__RobotInit_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RobotInit message array equality.
/**
...
/// Copy an array of srv/RobotInit messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_interface__srv__RobotInit_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_interface
...
/**
 * It calls
 * robot_interface__srv__RobotInit_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_interface
...
/**
 * It allocates the memory for the array and calls
 * robot_interface__srv__RobotInit_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_interface
...
/**
 * It calls
 * robot_interface__srv__RobotInit_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_INTERFACE__SRV__DETAIL__ROBOT_INIT__FUNCTIONS_H_
