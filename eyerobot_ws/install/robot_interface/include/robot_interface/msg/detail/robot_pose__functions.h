...
#ifndef ROBOT_INTERFACE__MSG__DETAIL__ROBOT_POSE__FUNCTIONS_H_
#define ROBOT_INTERFACE__MSG__DETAIL__ROBOT_POSE__FUNCTIONS_H_
 ...
 * calls
 * robot_interface__msg__RobotPose__init().
...
/**
 * It calls
 * robot_interface__msg__RobotPose__fini()
 ...
 * robot_interface__msg__RobotPose__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robot_interface__msg__RobotPose__Sequence__fini()
 * on the array,
...
#endif  // ROBOT_INTERFACE__MSG__DETAIL__ROBOT_POSE__FUNCTIONS_H_
